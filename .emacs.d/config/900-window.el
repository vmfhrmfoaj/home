(let* ((column-width 160)
       ...
       (main-monitor (--max-by (> (funcall get-resolution it) (funcall get-resolution other)) monitors))
       (geometry (-some->> main-monitor (nth 1) (-drop 1)))
       (main-monitor-l (nth 0 geometry))
       (main-monitor-t (nth 1 geometry))
       (main-monitor-w (nth 2 geometry))
       (main-monitor-h (nth 3 geometry)))
  (when window-system
